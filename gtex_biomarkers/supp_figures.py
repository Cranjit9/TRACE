...
from gtex_biomarkers.models import (
...
def compute_S2A_matrix():
    ...
    from gtex_biomarkers.data import variance_filter, build_confounder_matrix
    from gtex_biomarkers.labels import assign_donor_labels
    from gtex_biomarkers.models import _compute_pc_covariate_aucs
...
def build_S6A(mr_st_drv, mr_st_prt):
    ...
    from gtex_biomarkers.main_figure_panels import draw_mr_funnel, FUNNEL_STEAT
...
def build_S6B(mr_st_drv):
    ...
    from gtex_biomarkers.main_figure_panels import (
